...
class BoardController {
  ...
  render(tasks) {
    ...
    const newTasks = this._renderTasks(taskListElement, this._tasks.slice(0, this._showingTasksCount), this._onDataChange, this._onViewChange);
  ...
  _renderLoadMoreBtn() {
    ...
    this._loadMoreBtnComponent.setClickHandler(() => {
      ...
      // this._renderTasks(taskListElement, sortedTasks.slice(0, this._showingTasksCount));
